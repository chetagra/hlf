...
number=1
element=-2
domain=fabrictestnet1621.fabric.zeeve.net
channel=mychannel
network_path=etc/zeeve/fabric/841f6d3f-3e41-4c8e-a2f6-2675bce38ef9
...
number=1
element=-1
domain=fabrictestnet2622.fabric.zeeve.net
...
do 
    ...
    do 
        ...
        then
            ...
            component_rotate_certs $1 $2
            component_secrets $2
            kubectl scale deployment/peer-1org1-hlf-peer -n blockchain-org1 --replicas=0
            sleep 10
            kubectl scale deployment/peer-1org1-hlf-peer -n blockchain-org1 --replicas=1
            sleep 100
        fi
    done < "$file"
    update_crypto $2
